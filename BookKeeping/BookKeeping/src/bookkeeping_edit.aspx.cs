...
{
    public partial class bookkeeping_edit : System.Web.UI.Page
    {
        ...
        protected void SearchSelectMonth(MySqlConnection connection, int month)
        {
            ...
            string sql = "SELECT date, class_id, cost, mark FROM `112-112502`.bookkeeping_data where user_id = @user_id and year(date) = @year and month(date) = @month order by date;";
