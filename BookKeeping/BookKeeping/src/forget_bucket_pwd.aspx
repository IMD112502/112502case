        ...
        <div class="BMemo MemoStyle">
            <div class="TraWord">
                ...
                <div class="ForgetRevPwText">
                    ...
                    <p>重設審核密碼
                    <asp:TextBox class="TextBoxStyle" ID="UserPwd" runat="server" Width="145" Height="20" style ="margin-bottom:10px; padding-left:10px;" placeholder="請輸入4~6位密碼" ></asp:TextBox>
                    </p>
                    <p>確認審核密碼
                    <asp:TextBox class="TextBoxStyle" ID="TextBox1" runat="server" Width="145" Height="20" style ="margin-bottom:10px; padding-left:10px;" TextMode="Password" placeholder="請再次輸入密碼" ></asp:TextBox>
                    </p>
                </div>
